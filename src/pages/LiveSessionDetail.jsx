...
export default function LiveSessionDetail() {
  ...
  // Called when user intentionally leaves — clears cache so next visit re-joins
  const handleLeave = () => {
    sessionStorage.removeItem(cacheKey(id));
  ...
  return (
    ...
    >
      {/*
        TeacherControls is rendered inside ClassroomUI, NOT here.
        Passing sessionId + onLeave so ClassroomUI can wire them through.
      */}
